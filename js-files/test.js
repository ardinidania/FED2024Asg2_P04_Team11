...
newReviewCard.innerHTML = `
    ...
    <div class="review-content">
        ...
        <div class="stars">
            ...
            <span class="filled-stars" style="width: ${starWidth}%;">★★★★★</span>
        </div>
        <p>${reviewText}</p>
